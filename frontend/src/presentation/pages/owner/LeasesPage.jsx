...
export default function LeasesPage() {
  ...
  const save = async () => {
    ...
    try { await api.post("/leases", payload); toast.success("Lease created!"); setModal(null); load(); }
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => { setForm({ unit_id: "", tenant_id: "", start_date: "", end_date: "", monthly_rent: "", security_deposit: "" }); setModal(true); }} className="btn-primary"><HiOutlinePlus />New Lease</button>
      </div>
      ...
      {modal && (
        <Modal title="Create Lease" onClose={() => setModal(null)}>
